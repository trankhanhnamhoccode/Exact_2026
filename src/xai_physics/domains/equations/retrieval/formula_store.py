...
FORMULA_DOCS: list[FormulaDoc] = [
    ...
    FormulaDoc(
        id="parallel_all_currents",
        name="Branch currents and total current in a parallel circuit",
        equation="I_i = U/R_i; I_total = sum(I_i)",
        description="Use when a parallel-lamp problem asks for current through each lamp and the total current in one answer.",
        quantity_types=["voltage", "resistance", "current", "total_current"],
        query_types=["current", "total_current"],
        tags=["circuit", "parallel", "branch", "lamp", "current", "multi_output"],
        keywords=["current through each lamp and total current", "currents through each branch and main current", "parallel lamps each lamp total current"],
        schema_template=_schema(
            "parallel_all_currents",
            [
    ...
    FormulaDoc(
        id="total_power_sum",
        name="Total power from listed branch/lamp powers",
        equation="P_total = sum(P_i)",
        description="Use when powers of lamps/branches are individually given and total circuit power is requested.",
        quantity_types=["power", "branch_power", "total_power"],
        query_types=["total_power", "power"],
        tags=["circuit", "lamp", "power", "total_power"],
        keywords=["power of lamps total power", "sum of lamp powers", "total power from branch powers"],
        schema_template=_schema(
            "total_power_sum",
            [
                {"id": "P1", "type": "power", "role": "given", "value": "<number>", "unit": "W"},
                {"id": "P2", "type": "power", "role": "given", "value": "<number>", "unit": "W"},
